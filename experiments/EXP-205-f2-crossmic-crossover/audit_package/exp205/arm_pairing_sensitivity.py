...
PACKAGE = EXP if (EXP / "audit.json").is_file() else EXP / "audit_package" / "exp205"
SCORES = PACKAGE / "scores.portable.tsv"
MANIFEST = PACKAGE / "manifest.portable.json"
...
def main() -> int:
    ...
    output = {
        ...
        "limitations": [
            ...
            "These checks cannot alter or rescue the frozen pooled EXP-205 verdict.",

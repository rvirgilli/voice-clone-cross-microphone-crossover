#!/usr/bin/env python3
"""Build the EXP-212 job list: the EXP-205 grid over the fresh pairs.
...
def main() -> int:
    ...
    if manifest["schema"] != "exp212-fresh-pair-manifest-v1":
    ...
    out = RUN / "jobs.json"
    out.write_text(json.dumps({"schema": "exp212-fresh-pair-jobs-v1", "manifest": str(EXP212 / "selection-manifest-fresh.json"),
                               "jobs": jobs}, indent=1) + "\n", encoding="utf-8")

"""Build the outcome-blind this work input and cache trust root.

This builder authenticates the extension configuration, clone identities, audio,
ledgers, and opaque feature-cache files. It never opens embedding arrays,
scores.tsv, or a scientific-result file.
"""

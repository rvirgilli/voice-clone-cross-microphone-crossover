...
submitted manuscript, frozen score-level artifacts, preregistration and
amendments, the released analysis source, and executable checks that bind the
paper's claims to those records.
...
The release verifier authenticates every versioned file, independently
recomputes the 3,456-row EXP-205 census and its 100,000-bootstrap summaries,
checks the manuscript against EXP-202/204/205 records, and runs mutation tests
against the paper-facing checker. It does not generate or score audio.
...
All headline points, intervals, tables, sensitivities, census checks, and

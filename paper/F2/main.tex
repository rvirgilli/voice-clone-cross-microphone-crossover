...
comparison includes resynthesis effects. The carrier therefore stays bundled
in event-level prosody, articulation, background acoustics, paired-capture
room state and their interactions with model conditioning.

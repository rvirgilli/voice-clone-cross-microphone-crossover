...
An ASR transcript of every clone (Whisper-large-v3-turbo) matches its requested
text (median WER .04; 0 of 3,456 flagged) and shares no run longer than one
word with the conditioning transcript, so no clone repeats reference speech. The selected

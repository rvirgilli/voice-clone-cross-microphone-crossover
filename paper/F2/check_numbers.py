...
def main() -> int:
    ...
    required_statements = {
        ...
        "recovery disclosure": "one-field repair was recorded and independently approved before the result was opened",
        "independent recomputation": "independently reproduced every result field to $2\\times10^{-15}$",
        "portable score artifact": "prepared portable artifact contains sanitized scores",
        "portable independent verifier": "independent verifier that reconstructs the 3,456-row identity grid",

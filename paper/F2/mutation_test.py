...
CASES = [
    ...
    ("corrupt abstract EXP-206 ECAPA", ".805 [.780,.830]", ".805 [.680,.830]"),
    ("corrupt abstract EXP-206 reverse WavLM", ".612 [.593,.632]", ".612 [.493,.632]"),
    ...
    ("corrupt pooled EXP-206 primary ECAPA", "\\textbf{.805 [.780,.830]}", "\\textbf{.905 [.780,.830]}"),
    ("corrupt pooled EXP-206 reverse WavLM", "\\textbf{.612 [.593,.632]}", "\\textbf{.712 [.593,.632]}"),
    ...
    ("corrupt ancestry pass stratum", ".908/.907 among 36 earlier", ".808/.907 among 36 earlier"),
    ("corrupt ancestry fail stratum", ".879/.915 among 15 gate-fail", ".779/.915 among 15 gate-fail"),
    ("corrupt arm-separated ECAPA", "ECAPA is\n.889/.903", "ECAPA is\n.789/.903"),
    ("corrupt minimum arm cell", "minimum .523", "minimum .423"),
    ("corrupt EXP-206 comparison count", "contains 31,104 comparisons", "contains 30,104 comparisons"),
    ("corrupt EXP-206 material ECAPA bar", "ECAPA points $\\geq.60$", "ECAPA points $\\geq.70$"),

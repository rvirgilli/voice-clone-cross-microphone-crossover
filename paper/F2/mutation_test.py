...
CASES = [
    ...
    ("drop portable verifier", "independent verifier that\nreconstructs the", "script that merely\nreads the"),
    ...
    ("drop pre-opening recovery disclosure", "before the result was opened", "after analysis"),
    ...
    ("revive operational overclaim", "meets the pre-registered large-effect criterion", "is operationally large"),
